...
/*LGE_CHANGE_E, Make EEPROM CheckSum Property for AAT Mode, 2016-02-23, seungmin.hong@lge.com*/
		if(!rc) {
			...
			/*LGE_CHANGE_S, update main_sensor_id for s5k5e2 cowell module, 2016-08-26, jungryoul.choi@lge.com */
			...
			/*LGE_CHANGE_E, update main_sensor_id for s5k5e2 cowell module, 2016-08-26, jungryoul.choi@lge.com */
